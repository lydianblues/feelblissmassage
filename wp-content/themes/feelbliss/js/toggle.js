...
document.getElementById("berkeley-btn").addEventListener("click", function(){
    $elt1 = document.getElementById("oakland-map");
    $elt2 = document.getElementById("berkeley-map");
    $elt3 = document.getElementById("orinda-map");
    $elt1.style.zIndex = 8;     
